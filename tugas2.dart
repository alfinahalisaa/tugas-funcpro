...
var fizzBuzz = (start, stop) =>  List.generate((stop - start) + 1, (index) => start+index).map((number) => number % 3 == 0 && number % 5 == 0 ? 'FizzBuzz' : number % 3 == 0 ? 'Fizz' : number % 5 == 0 ? 'Buzz' : number).toList();
